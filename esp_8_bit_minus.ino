...
//  Choose one of the following emulators: EMU_SG1000
#define EMULATOR EMU_SG1000
...
Emu* NewEmulator() {  
  #if (EMULATOR==EMU_SG1000)
    return NewSG1000(VIDEO_STANDARD);
  #endif

  printf("Must choose one of the following emulators: EMU_SG1000\n");
}
